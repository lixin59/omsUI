  ...
  return (
    <>
      ...
      <TextField
        ...
        onChange={(e) => setHostInfo({ ...hostInfo, vnc_port: Number(e.target.value) })}
      />
      {/* <TextField*/}
      {/*  autoFocus*/}
      {/*  margin='dense'*/}
          ...
          <>
            ...
            <Select
              ...
              onChange={(e) =>
                setHostInfo({
                  ...hostInfo,
                  group: groupArr.find((item) => item.name === (e?.target?.value as string)) as GroupInfo
                })
              }>
              {groupArr.map((e) => {
                return (
            ...
            tlc.map((e, index) => {
              return (
                <FormControlLabel
                  ...
                  label={<Chip className={classes.tag} size="small" key={e.id} label={e.name} />}
                />
              );
            })}
        </FormGroup>
